...
/** Filesystem fallback for `zafirixpro.com/fr?ref=` (Facebook / in-app browsers). */
export default async function FrenchAliasPage({
  searchParams,
}: {
  ...
  redirect(ref ? `/landing/fr?ref=${encodeURIComponent(ref)}` : '/landing/fr');
}
